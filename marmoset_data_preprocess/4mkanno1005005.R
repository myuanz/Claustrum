...
dataDir=paste0('/home/liuyx/liuyuxuan/spa_seurat/cla/marmoset/batch_normalize_renew_240115/dif_res_anno/')
...
OPC1@meta.data$Subclass=paste0(OPC1@meta.data$maxPredClass,'_0')
MSN1@meta.data$Subclass=paste0(MSN1@meta.data$maxPredClass,'_0')
