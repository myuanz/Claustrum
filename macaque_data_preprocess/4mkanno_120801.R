...
dataDir=paste0('/home/liuyx/liuyuxuan/spa_seurat/cla/macaca/sn_0821_renew_batch3_all/batch_normalize_renew_0105/dif_res_anno1/')
...
Excit1 = RunHarmony(
    Excit1, group.by.vars="donor2", plot_convergence=T,
...
Inhibit1 = RunHarmony(
    Inhibit1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
Inhibit1 = Inhibit1 %>%
    FindNeighbors(reduction="harmony", dims = 1:30) %>%
...
Astrocytes1 = RunHarmony(
    Astrocytes1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
...
Oligo1 = RunHarmony(
    Oligo1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
Oligo1 = Oligo1 %>%
    FindNeighbors(reduction="harmony", dims = 1:30) %>%
...
Microglia1 = RunHarmony(
    Microglia1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
...
OPC1 = RunHarmony(
    OPC1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
OPC1 = OPC1 %>%
    FindNeighbors(reduction="harmony", dims = 1:30) %>%
...
MSN1 = RunHarmony(
    MSN1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
MSN1 = MSN1 %>%
    FindNeighbors(reduction="harmony", dims = 1:30) %>%
...
Endotheial1 = RunHarmony(
    Endotheial1, group.by.vars="donor2", plot_convergence=T,
    reduction = "pca", dims.use=1:30,
    theta=2,)
...
Microglia1@meta.data$Subclass=paste0(Microglia1@meta.data$maxPredClass,'_0')
