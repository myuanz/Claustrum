...
dataDir=paste0('/home/liuyx/liuyuxuan/spa_seurat/cla/speciesCompare/1019_Putamen_Amygdala_analysis/batch_normalize_renew_240115/dif_res_anno/')
...
#classFiltSeurat=subset(classFiltSeurat,downsample=200)
...
Endotheial1=Endotheial
Microglia1=Microglia
